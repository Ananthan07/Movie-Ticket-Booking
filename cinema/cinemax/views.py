...
from cinemax.forms import CreateMovieForm
from rest_framework.exceptions import PermissionDenied
from datetime import datetime,date
from cinemax.models import BookingRegister
...
#         send_booking_confirmation_email(booking, movie)
...
# def send_booking_confirmation_email(booking, movie):
#     template = get_template('booking_details.html')
#     context = {'booking_data': booking, 'movie_instance': movie}
